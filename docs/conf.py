...
latex_documents = [
    (master_doc, "pyEX.tex", "pyEX Documentation", "Tim Paine", "manual"),
]
...
man_pages = [(master_doc, "pyEX", "pyEX Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    subprocess.check_call([cmd_path, "-E", "-M", "-o", out_dir, pyEX_dir, "--force"])
